          ...
          <div className="p-5 border-b border-border/40 bg-secondary/20 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                DevDeck runs directly on your machine. It analyzes your local project folders and Git metadata without uploading source code to external servers.
              </p>
            </div>
          </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {workspaceSelection
                        ...
                        : "Link the local project folders where your work lives."}
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-lg border border-border/60 bg-white shadow-sm hover:border-black/20 transition-colors">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Viewer: {githubStatus?.viewerLogin ?? "Not authenticated"} · Connected projects: {githubStatus?.connectedRepositoryCount ?? 0}
                    </p>
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-col gap-3 p-3 rounded-md transition-colors hover:bg-secondary/30 sm:flex-row sm:items-center sm:justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">
                      DevDeck uses this tool for all "Open in..." actions across project sessions.
                    </p>
